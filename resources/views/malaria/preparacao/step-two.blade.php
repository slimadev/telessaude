<div class="result-form " id="dvStepTwo" style="display:none">
    ...
    <!--<div class="custom-text-result" style="color:red;"><strong>Positivo-Malária complicada/grave</strong></div>-->
     <img id='imagem1'  alt="" width="200" height="200" class='dist'/>
   
    <div class="card mb-3" style="min-width: 540px;">
  <div class="row g-0" >
    <div class="col-md-2 d-flex flex-col align-items-center">
      <button type="button" class="btn btn-primary" style="margin-left: 30px" id="btnPreparacaoBack"><i class="bi bi-caret-left" style="font-size: 20px;"></i></button>
    </div>
    <div class="col-md-8">
      <div class="card-body" style="text-align:center;">
        <h5 class="card-title"></h5>
        <p class="card-text">
          <div class="custom-text-result" id="preparacaoStepTwoSlOne">
              <!-- inserir informacao  -->
    ...
    <div class="col-md-2  d-flex flex-col align-items-center" >
      <button type="button" class="btn btn-primary" id="btnPreparacaoNext"><i class="bi bi-caret-right" style="font-size: 20px;"></i></button>
    </div>
  </div>
</div>
    ...
    <button type="submit" class="btn btn-primary" id="btnStepTwoNext">Próximo</button>
</div>
<div class="result-form " id="dvStepTwo" style="display:none">
  ...
  <div class="row g-0" >
    ...
    <button type="button" class="btn btn-primary" style="margin-left: 30px" id="btnMalariaBack"><i class="bi bi-caret-left" style="font-size: 20px;"></i></button>
    </div>
    <div class="col-md-8">
      <div class="card-body" style="text-align:center;">
        <h5 class="card-title"></h5>
        <p class="card-text"><div class="custom-text-result" id="malariaStepTwoTest"><strong>Febre < 39ᵒ</strong></div></p>
      </div>
    </div>
    <div class="col-md-2  d-flex flex-col align-items-center" >
    <button type="button" class="btn btn-primary" id="btnMalariaNext"><i class="bi bi-caret-right" style="font-size: 20px;"></i></button>
    </div>
  </div>
</div>

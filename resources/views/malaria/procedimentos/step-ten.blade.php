<div class="result-form " id="dvStepTen" style="display:none">
      <div class="row" style="background-color:#012970 ;">
        ...
        <div class="col-lg-11 hero-img" data-aos="zoom-out" data-aos-delay="200">
            ...
            <strong>PASSO 10:</strong>  Descarte o tubo capilar na caixa para material perfuro-cortante
            </div>
        </div>
    </div>
    ...
    <br/>
    <hr/>
    <button type="submit" class="btn btn-primary" id="btnStepTenBack">Anterior</button>
    <button type="submit" class="btn btn-primary" id="btnStepTenNext">Próximo</button>
</div>

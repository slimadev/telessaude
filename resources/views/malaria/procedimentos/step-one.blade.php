<div class="result-form " id="dvStepTwoOn" style="display:none">
    ...
    <img id='imagem'  alt="" width="200" height="200" class='dist'/>
  ...
  <div class="row g-0" >
    ...
    <div class="col-md-8">
      <div class="card-body" style="text-align:center;">
        ...
        <p class="card-text">
          <div class="custom-text-result" id="procedimentosStepOneSlOne">
              <!-- inserir informacao  -->
    ...
    <div class="col-md-2  d-flex flex-col align-items-center" >
      <button type="button" class="btn btn-primary" id="btnProcedimentosNext"><i class="bi bi-caret-right" style="font-size: 20px;"></i></button>
    </div>
  </div>
</div>

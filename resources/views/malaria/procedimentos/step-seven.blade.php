<div class="result-form " id="dvStepSeven" style="display:none">
      <div class="row" style="background-color:#012970 ;">
        ...
        <div class="col-lg-11 hero-img" data-aos="zoom-out" data-aos-delay="200">
            ...
            <strong>PASSO 7:</strong>  Descarte a lanceta na caixa para material perfuro-cortante
            </div>
        </div>
    </div>
    ...
    <br/>
    <hr/>
    <button type="submit" class="btn btn-primary" id="btnStepSevenBack">Anterior</button>
    <button type="submit" class="btn btn-primary" id="btnStepSevenNext">Próximo</button>
</div>

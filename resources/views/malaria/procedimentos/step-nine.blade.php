<div class="result-form " id="dvStepNine" style="display:none">
    ...
    <br/>
    <hr/>
    <button type="submit" class="btn btn-primary" id="btnStepNineBack">Anterior</button>
    <button type="submit" class="btn btn-primary" id="btnStepNineNext">Próximo</button>
</div>

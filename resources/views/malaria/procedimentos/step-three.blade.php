<div class="result-form " id="dvStepThree" style="display:none">
  ...
  <div class="row g-0" >
    <div class="col-md-2 d-flex flex-col align-items-center">
      <button type="button" class="btn btn-primary" style="margin-left: 30px" id="btnProcedimentosStepThreeBack"><i class="bi bi-caret-left" style="font-size: 20px;"></i></button>
    </div>
    <div class="col-md-8">
      <div class="card-body" style="text-align:center;">
        <h5 class="card-title"></h5>
        <p class="card-text">
          <div class="custom-text-result" id="procedimentosStepThree">
              <!-- inserir informacao  -->
    ...
    <div class="col-md-2  d-flex flex-col align-items-center" >
      <button type="button" class="btn btn-primary" id="btnProcedimentosStepThreeNext"><i class="bi bi-caret-right" style="font-size: 20px;"></i></button>
    </div>
  </div>
</div>

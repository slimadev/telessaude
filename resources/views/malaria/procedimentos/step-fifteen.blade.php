<div class="result-form " id="dvStepFifteen" style="display:none">
    ...
    <!--<div class="custom-text-result" style="color:red;"><strong>Positivo-Malária complicada/grave</strong></div>-->
         <img id='imgSlFifteen'  alt="" width="200" height="200" class='dist'/>
    ...
    <br/>
    <hr/>
    <button type="submit" class="btn btn-primary" id="btnStepFifteenBack">Anterior</button>
    <button type="submit" class="btn btn-primary" id="btnStepFifteenNext">Próximo</button>
</div>

<div class="result-form " >
    ...
    <div class="col-lg-11 hero-img" data-aos="zoom-out" data-aos-delay="200">
        <ul>
          <li>
          Pacientes com doença cardiovascular, fazer a primeira fase de hidratação em 6 horas e fazer monitoria de sinais de sobrecarga de fluidos a cada 30 minutos (Vide fluxograma de tratamento das complicações)
          </li>
          <li>

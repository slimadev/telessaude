<div class="result-form " >
    ...
    <div class="col-lg-11 hero-img" data-aos="zoom-out" data-aos-delay="200">
        @if($is_child ==1)
            ...
            <ol>
            <li>
            Tabela de reidratação em crianças com mais de 5 anos e adultos <a href="{{url('/download/Anexo II.pdf')}}">consultar anexo II </a> 
            </li>
            <li>
            Tabela de reidratação em crianças com menos de 5 anos <a href="#">consultar anexo III </a>
            </li>
            <li>
            Tabela de reidratação em crianças desnutridas <a href="#">consultar anexo IV </a>
            </li>
            </ol>
